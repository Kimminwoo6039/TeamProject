...
public class NaverVo {
	...
	private long n_number;	// pk·Î ¾µ °ª
	...
	public String toString() {
		return "NaverVo [n_number=" + n_number + ", n_age=" + n_age + ", n_birthday=" + n_birthday + ", n_email="
				+ n_email + ", n_gender=" + n_gender + ", n_id=" + n_id + ", n_name=" + n_name + ", n_nickName="
				+ n_nickName + "]";
	}
