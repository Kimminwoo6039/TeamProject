        ...
        <!--  <i class="fa fa-user"></i>  -->
         ...
         <div class="input_text">
          ...
          <div class="forgot" style="margin-bottom: 30px;">
           ...
           <a class="p-2" href="https://kauth.kakao.com/oauth/authorize?client_id=b3c90d252e0ab2e93579050eaf013549&redirect_uri=http://192.168.0.145:8090/shop/kakao.do&response_type=code">
