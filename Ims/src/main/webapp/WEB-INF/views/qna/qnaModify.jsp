...
<c:if test="${sessionScope.name == null}">
	...
	<form name="moveForm" method="post" action="/shop/qna/update.do" enctype="multipart/form-data">
	...
	<input type="hidden" name="q_bidx" value="${vo.q_bidx }">
		...
		<div class="">
			...
			<div class="">
				<div class="">
					제목<input type="text" class="" id="title" placeholder="title" name="q_title" value="${vo.q_title }" aria-label="Recipient's username" aria-describedby="button-addon2"><br>
		...
		<!--  -->
		<div>
			내용<textarea name="q_content" rows="" cols="" id="content">${vo.q_content}</textarea>
